...
format_key = 'meikai/arrival-notice-format.xlsx'
...
def lambda_handler(event, context):
    try:
        ...
        key_to_cell_mapping = {
            ...
            "Total prepaid": "",
            "Doean Vensel/Vcy No": "B20",
            "Pre-carriage By'": "E20",
            "Forwarding Age 14 Reference (For Cargo Delivery Apply To": "",
            "First Destination": "",
            "B/L No.": "",
            "Revenue Tons": "",
            "Marks Numbers/Container No. Seall No.": "A32",
            "Rate": "",
            "Freigt 18 Charges": "",
            "Prepaid": "",
            "Collect": "",
            ...
            "Shipper": "A5",
            "TEL:": "",
            "Number and Kinds of packages: Description of goods": "D32",
            "Vensurement(Com)": "",
            "Gross Weight (Kgs)": "",
            "LADEN ON BOARD THE VESSE": "",
            "FAX 81-": "",
            "FAX": ""
        }
        # ヘッダーとセルのマッピング
