...
format_key = 'sauling/arrival-notice-format.xlsx'
...
def lambda_handler(event, context):
    try:
        ...
        key_to_cell_mapping = {
            ...
            "TOTAL NO.OF CONTAINERS OF PACKAGES(IN WORDS)": "",
            "YFL17": ""
        }
        # ヘッダーとセルのマッピング
        header_to_cell_mapping = {
            "CONTAINER NO. SEAL NO. MARKS AND NUMBER": "A32",
            "NO.OF CONTAIN- ERS OR PKGS.": "C32",
