...
import UniwinUploader from "components/molecules/UniwinUploader";
...
const apiClient = axios.create({
    baseURL: 'https://etxpi6wnfc.execute-api.ap-northeast-2.amazonaws.com/prod/uniwin',
    headers: {
...
const UniwinUploadForm: FC = () => {
    ...
    return (
        <div className="flex flex-col items-center p-8 m-8 bg-gray-100 rounded shadow-md">
            <Title level="h2" className="mb-4">UNIWIN Uploader</Title>
            <UniwinUploader onFileChange={handleFileUpload} />
        </div>
    );
};

export default UniwinUploadForm;
