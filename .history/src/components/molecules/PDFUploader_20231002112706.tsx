...
const PDFUploader: FC<PDFUploaderProps> = ({ onFileChange }) => {
    ...
    return (
        <div className="flex flex-col items-start space-y-4">  // 縦並びに変更
            ...
            {selectedFileName && <span className="text-sm text-gray-600">選択されたファイル: {selectedFileName}</span>}  // 選択したファイル名を表示
        </div>
    );
};
